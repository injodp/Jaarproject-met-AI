...
picam2 = Picamera2()
picam2.configure(picam2.create_preview_configuration(main={"format": 'XRGB8888', "size": (840, 840)}))
picam2.start()
...
authorized_names = ["injo"]  # Replace with names you wish to authorise THIS IS CASE-SENSITIVE
